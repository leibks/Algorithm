...
// Constant time.
public class InsertionSortGreedy {
	public static void main(String[] args) {
		...
		// Sort by earliest finish time, then iterate through the sorted list and add the next non-overlapping request
		// to your schedule until you have iterated through everything
